// File: CSnowmanGame.h
// This header file contains the declaration for the CSnowmanGame class. The class is used in main.cpp to start the game of Snowman.
...
private:
	...
	void DispTitle(char const* title, bool header = true, bool footer = true, bool headerSpace = true, bool footerSpace = true) const;
